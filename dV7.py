...
class LinuxPlusStudyGame:
    ...
    def update_history(self, question_text, category, is_correct):
        ...
        if is_correct:
            ...
            if question_text in history.get("incorrect_review", []):
    ...
    def select_question(self, category_filter=None):
        ...
        if not possible_indices:
            # This case means no questions exist for the filter AT ALL
        ...
        if not available_indices:
             # print(f"{COLOR_INFO} No available questions left for this filter in this session. {COLOR_RESET}")
...
class LinuxPlusStudyGUI:
    ...
    def _load_initial_state(self):
        ...
        self.review_button.config(state=tk.NORMAL if self.game_logic.study_history.get("incorrect_review", []) else tk.DISABLED)
    ...
    def _submit_answer_gui(self):
        ...
        if user_answer_index == -1:
            ...
            return # Silently ignore if no answer selected and button somehow clicked
    ...
    def _review_incorrect_gui(self):
        ...
        # --- Populate Review Text (same as before) ---
...
if __name__ == "__main__":
    ...
    if not is_interactive:
        # print("Non-interactive environment detected or arguments provided. Defaulting to CLI.") # Optional print
        ...
        while interface_choice not in ['cli', 'gui']:
            ...
            try:
                ...
                print(COLOR_RESET_STR, end='')
                 ...
                 print(f"\n{COLOR_ERROR_STR} Input interrupted. Exiting. {COLOR_RESET_STR}")
                 sys.exit(1)
